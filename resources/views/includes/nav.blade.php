<!--Navbar -->
<nav class="mb-1 navbar fixed-top navbar-expand-lg navbar-dark gradiente-nav scrolling-navbar">
    <div class="container">  
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            ...
            <ul class="navbar-nav ml-auto nav-flex-icons">
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-light" title="Administrador">
